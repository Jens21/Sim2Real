...
PRE_LABELING="New"
NUMBER_OF_IMAGES=1	#TODO 10000
START_AT_IMAGE_NUMBER="$((SLURM_ARRAY_TASK_ID*NUMBER_OF_IMAGES+0))"
THREAD_LIMIT=1	#TODO 80
DIR_INPUT="/pfs/data5/home/kit/anthropomatik/yc5412/Sim2Real/amira/distractor within parts/OutputTrain/"
DIR_OUTPUT="/pfs/data5/home/kit/anthropomatik/yc5412/Sim2Real/ConvertAmira2YCB/OutputTrain/"
DIR_BACKGROUND_TEXTURES="/pfs/data5/home/kit/anthropomatik/yc5412/Sim2Real/amira/textures/"

python script.py -- --START_AT_IMAGE_NUMBER="$START_AT_IMAGE_NUMBER" --PRE_LABELING="$PRE_LABELING" --NUMBER_OF_IMAGES="$NUMBER_OF_IMAGES" --THREAD_LIMIT="$THREAD_LIMIT" --DIR_INPUT="$DIR_INPUT" --DIR_OUTPUT="$DIR_OUTPUT" --DIR_BACKGROUND_TEXTURES="$DIR_BACKGROUND_TEXTURES"
