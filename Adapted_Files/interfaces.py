...
class PoseRenderResult:
    ...
    def __init__(self, object_class_name, object_class_id, object_name, object_id,
        ...
        #aditionally added
        #############################################################################################
        self.n_not_visible=n_not_visible,
        self.n_occluded=n_occluded,
        self.n_not_visible_and_occluded=n_not_visible_and_occluded,
    ...
    def state_dict(self, retain_keys: list = None):
        data = {
            ...
            #aditionally added
            #############################################################################################
            "n_pix_not_visible": self.n_not_visible,
            "n_pix_occluded": self.n_occluded,
            "n_pix_not_visible_and_occluded": self.n_not_visible_and_occluded,
            "n_pix": self.n_pixels,
